    ...
    <body>
        ...
        <main class="container">
            ...
            <div class="container mt-5 selection">
                ...
                // Sample items array
                $items = [
                    ["name" => "Item 1", "price" => "$10.00", "image" => "images/keycaps/keycap.jpg", "desc" => "Lorum ipsum"],
                    ["name" => "Item 2", "price" => "$15.00", "image" => "images/keycaps/keycap.jpg", "desc" => "Lorum ipsum"],
                    ["name" => "Item 3", "price" => "$20.00", "image" => "images/keycaps/keycap.jpg", "desc" => "Lorum ipsum"],
                    ["name" => "Item 4", "price" => "$25.00", "image" => "images/keycaps/keycap.jpg", "desc" => "Lorum ipsum"],
                    ["name" => "Item 5", "price" => "$30.00", "image" => "images/keycaps/keycap.jpg", "desc" => "Lorum ipsum"],
                    ["name" => "Item 6", "price" => "$35.00", "image" => "images/keycaps/keycap.jpg", "desc" => "Lorum ipsum"],
                    ["name" => "Item 7", "price" => "$40.00", "image" => "images/keycaps/keycap.jpg", "desc" => "Lorum ipsum"],
                    ["name" => "Item 8", "price" => "$45.00", "image" => "images/keycaps/keycap.jpg", "desc" => "Lorum ipsum"],
                    ["name" => "Item 9", "price" => "$45.00", "image" => "images/keycaps/keycap.jpg", "desc" => "Lorum ipsum"],
                ];
